...
EllipsisText.propTypes = {
  ...
  fullWidthRecognition: PropTypes.bool.isRequired
};
...
export default class Ellipsis extends PureComponent {
  ...
  render() {
    ...
    const cls = classNames('app-ellipsis', className, {
      'app-lines': lines && !isSupportLineClamp,
      'app-lineClamp': lines && isSupportLineClamp
    });
